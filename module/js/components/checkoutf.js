class CheckoutF extends HTMLElement{
    connectedCallback() {
        this.innerHTML = `
            <!-- CHECKOUTF STRUCTURE -->
            <div class="checkoutf-page-display">
                <div class="about-page-display">
                        ...
                        <div class="container" >
                            <div class="list-nav-con">
                                <div class="custom-row">
                                    <div class="list-back-btn" id="checkout-back-btn"><img class="img-fluid" src="img/icon/back.png"></div>
                                    <span class="help-header-txt one-line nav-left-padding">Checkout</span>
                                </div>
                                <div class="item-detail-btn white-font" onclick="ItemToDetail()">Review details</div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="checkout-item-wrap" id="checkout-first-page">
                    ...
                    <div class="category-section checkout-section">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-10 col-lg-6">
                                    <div class="checkout-use-btn" onclick="ToNotify()">Use this address</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
customElements.define("checkoutf-page", CheckoutF);
...
// --------------------  ITEM CHANGER FUNCTIONS  -------------------- 
    //  
    function CheckoutChanger() {
        document.getElementById("checkout-first-page").innerHTML = `
            <div class="container">
                <div class="row" style="align-items:center;">
                    <div class="col-4">
                        <div class="checkout-img-wrap"><img src="img/${ ItemSelector[ItemIndex].image1 }" class="checkout-img-fluid"><div class="free-container">Free</div></div>
                    </div>
                
                    <div class="col-8 ml-3">
                        <p class="item-name line-height two-lines">${ ItemSelector[ItemIndex].name }</p>
...
function CheckoutValidation() {
    let validate = document.forms["valid-form"]["validation"].value;
    if (validate == 0){
        alert("Complete feild requirements")
    } else{
